...
@NonNullApi
public class WordConverterProjectDependency extends DelegatingProjectDependency {

    @Inject
    public WordConverterProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
